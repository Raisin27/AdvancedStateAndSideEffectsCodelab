...
fun DetailsScreen(
    ...
    val uiState by produceState(initialValue = DetailsUiState(isLoading = true)) {
        // Trong một coroutine, cái này có thể gọi hàm tạm dừng hoặc di chuyển
        // tính toán cho các Bộ điều phối khác nhau- Dispatches
    ...
    when {
        ...
        uiState.isLoading -> {//vòng quay đang tải xuất hiện trước khi thấy thông tin chi tiết về thành phố
